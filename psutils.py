...
# from partitionutil import admittance_to_BBD
...
def initialize_emt(workingfolder, systemN, N_row, N_col, ts, Tlen, mode='bbd'):
    ...
    if systemN == 1:
        ...
        fdyd = workingfolder + 'models/240bus_psse/240bus.xls' 
    elif systemN == 6:
        fdyd = workingfolder + 'models/2area_psse/twoarea.xls'
    else:
        pass
    ...
    ti_12 = time.time()
    ini.MergeMacG(pfd, dyd, emt.ts, [], mode=mode)
    print('Merged MacG')
    ti_13 = time.time()
