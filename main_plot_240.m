...
dataVbus = readtable('emt_3phaseV.csv');
...
%% 3phase voltage
bus_Va = table2array(dataVbus(:,1:1:bus_n));
bus_Vb = table2array(dataVbus(:,bus_n+1:1:2*bus_n));
bus_Vc = table2array(dataVbus(:,2*bus_n+1:1:3*bus_n));
%% end of 3 phase voltage 
